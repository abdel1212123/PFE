...
<div class="parag "> 
     ...
     <h1> <i class="fa-solid fa-folder"></i> Lycée </h1>
 </div>
 
 <ul>
             <div class="title-box">
                    <h2> <i class="fa-regular fa-folder-open"></i> 5ème Année Primaire</h2>
                 </div>
                      
                 <li>
          <i class="fas fa-book"></i> <a href="#">Mathématiques (Fr)</a>
        </li>
    ...
    <ul>
             <div class="title-box">
                    <h2> <i class="fa-regular fa-folder-open"></i> 6ème Année Primaire</h2>
                 </div>
                      
                 <li>
          <i class="fas fa-book"></i> <a href="#">Mathématiques </a>
        </li>
