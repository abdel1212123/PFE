...
<div class="parag "> 
 ...
 <ul>
             <div class="title-box">
                    <h2> <i class="fa-regular fa-folder-open"></i> Tronc commun </h2>
                 </div>
    ...
    <ul>
             <div class="title-box">
                    <h2> <i class="fa-regular fa-folder-open"></i> 1ère année bac (Sc.Ex)</h2>
                 </div>
    ...
    <ul>
             <div class="title-box">
                    <h2> <i class="fa-regular fa-folder-open"></i> 2ème année bac (Sc.Ex)</h2>
                 </div>
